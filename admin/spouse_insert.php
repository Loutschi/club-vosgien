...
if (isset($_POST['ajouter'])) {
    ...
    if ($_SESSION['paymod'] == 'cb') {
        echo '<script type="text/javascript">document.location.replace("https://www.payasso.fr/cvmc/cotisations");</script>';
            ...
            $_SESSION['paychq'] = "Votre adhésion a bien été enregistrée, et nous vous en remercions. <br>
            Vous avez choisi de payer votre adhésion par chèque. Veuillez l'établir à l’ordre du Club Vosgien de Mulhouse & Crêtes et l'envoyer à l’adresse du siège de l’association : 33 Grand Rue 68100 MULHOUSE.";
        }
    exit();
}
...
<div class="container">
    ...
    <div class="row justify-content-center mt-4">
        ...
        <form class="pt-4 pb-4 bg-secondary text-white form-inline" action="" id="form" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4 form-group">
                <label style="width:150px" class="d-inline pl-4" for="spouse_firstname">Prénom du conjoint</label>
            ...
            <div class="mb-4 form-group">
                <label style="width:150px" class="d-inline pl-4" for="spouse_lastname">Nom du conjoint</label>
                <input style="width:230px" type="text" class="form-control" id="spouse_lastname" name="spouse_lastname" value="<?php if (isset($_POST['spouse_lastname'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_dob" name="spouse_dob" value="<?php if (isset($_POST['spouse_dob'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_profession" name="spouse_profession" value="<?php if (isset($_POST['spouse_profession'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:750px" type="text" class="form-control" id="spouse_address" name="spouse_address" value="<?php if (isset($_POST['spouse_address'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_zip" name="spouse_zip" value="<?php if (isset($_POST['spouse_zip'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_city" name="spouse_city" value="<?php if (isset($_POST['spouse_city'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_country" name="spouse_country" value="<?php if (isset($_POST['spouse_country'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_phone" name="spouse_phone" value="<?php if (isset($_POST['spouse_phone'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_mobile" name="spouse_mobile" value="<?php if (isset($_POST['spouse_mobile'])) {
            ...
            <div class="mb-4 form-group">
                ...
                <input style="width:250px" type="text" class="form-control" id="spouse_email" name="spouse_email" value="<?php if (isset($_POST['spouse_email'])) {
